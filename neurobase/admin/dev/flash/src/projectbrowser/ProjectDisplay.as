package projectbrowser{
	...
	public class ProjectDisplay extends MovieClip{
		...
		public function ProjectDisplay():void{
			...
			numPermanent++;
			path.y = dataOptions.y + dataOptions.height + 15;
			path.x = 17;
			addChild(path);
		...
		private function changeDisplay(res:Array):void{
			...
			//display the options for this project, if it has sequences
		...
		public function positionProjectOptions():void{
			if(this.getChildByName('loadSeqs')){
				var tmp:LoadNode = LoadNode(
			}
		}
