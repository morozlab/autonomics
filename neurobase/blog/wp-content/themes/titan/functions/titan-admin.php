...
<div id="v-options">
  ...
  <div id="vop-header"><p><strong><?php _e( 'Need help?', 'titan') ?></strong> <a href="http://thethemefoundry.com/downloads/titan/"><?php _e( 'Read the tutorials' , 'titan')?></a> <?php _e('or visit the <a href="http://thethemefoundry.com/forums/">support forums.</a>', 'titan')?></p></div>  
  <div class="v-notice">
    <?php _e( 'You are using the free version of Titan. <a href="http://thethemefoundry.com/titan/">Learn more about Titan PRO &rarr;', 'titan') ?></a>
  </div>
  <div id="vop-body">
    <form method="post">
<?php
