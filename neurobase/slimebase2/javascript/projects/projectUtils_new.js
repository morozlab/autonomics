...
function loadProjectDetails(){
	...
	request.open("GET", "ajax/project_view/utils_new.php?method=loadProjectDetails&args=" + selectBox.options[index].value, true);
	request.send(null);
}
...
function displayNavigation(selectedID){
	...
	request.open("GET", "ajax/project_view/utils_new.php?method=displayNavigation&args=" + selectedID, true);
	request.send(null);
}	
...
function displayExtraContent(projectID){
	...
	request.open("GET", "ajax/project_view/utils_new.php?method=loadExtraContent&args=" + projectID, true);
	request.send(null);
}
...
function loadComparisonAlignment(projectID1, projectID2, sbID1, sbID2){
	...
	request.open("GET", "ajax/project_view/utils_new.php?method=loadAlign&args=" + projectID1 + "," + projectID2 + "," + sbID1 + "," + sbID2, true);
	request.send(null);
}
...
function reloadSecondSelect(){
	...
	request.open("GET", "ajax/project_view/utils_new.php?method=reloadSecondSelect&args=" + selectedVal, true);
	request.send(null); 
}