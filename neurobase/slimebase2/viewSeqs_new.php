...
include('../includes/slimebase2/browsing/browseUtilsv2_new.php');
...
<link href="../css/seq_view_new.css" rel="stylesheet" type="text/css" />
    	...
    	<?php
			...
			//second case, we're viewing sequences from a search result
				...
				if($projectID == -1){
					...
					displaySearchResult($resultArray, $resultWithAnnotation);
				}
			}
